...
Public Class CriminalUpdateForm
    ...
    Private Sub SaveRecords()
        ...
        command.Parameters.Add("@Height", SqlDbType.NVarChar).Value = TextBox7Height.Text
        ...
        command.Parameters.Add("@AresstingOfficer", SqlDbType.NVarChar).Value = ComboBox2.Text
